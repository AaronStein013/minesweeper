 ...
 * 
 * Purpose: - Practice with OOP
 * 			- Practice thinking about larger programs
 * 			- Practice with version control on Github
 * 
 * Description:	- In main() method, can alter size of board and number of bombs
 ...
 * 
 * 
 * Next improvements: 	- Add error handling so that only proper commands or valid indexes
 * 						  can be inputed
 * 						- Use logic and methods implemented here to implement interactive GUI
 * 					 	  that makes the game more intuitive/user-friendly to play
 */
